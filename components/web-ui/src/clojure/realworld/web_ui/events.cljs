...
;;
(def remove-user-interceptor [(after db/remove-user-ls)])
...
(def >initialise-db ::initialise-db)
(def >set-active-page ::set-active-page)
(def >reset-active-article ::reset-active-article)
(def >set-active-article ::set-active-article)
(def >get-articles ::get-articles)
(def >get-articles-success ::get-articles-success)
(def >get-article ::get-article)
(def >get-article-success ::get-article-success)
(def >upsert-article ::upsert-article)
(def >upsert-article-success ::upsert-article-success)
(def >delete-article ::delete-article)
(def >delete-article-success ::delete-article-success)
(def >get-feed-articles ::get-feed-articles)
(def >get-feed-articles-success ::get-feed-articles-success)
(def >get-tags ::get-tags)
(def >get-tags-success ::get-tags-success)
(def >get-article-comments ::get-article-comments)
(def >get-article-comments-success ::get-article-comments-success)
...
(def >login ::login)
(def >login-success ::login-success)
(def >register-user ::register-user)
(def >register-user-success ::register-user-success)
(def >update-user ::update-user)
(def >update-user-success ::update-user-success)
(def >toggle-follow-user ::toggle-follow-user)
(def >toggle-follow-user-success ::toggle-follow-user-success)
(def >toggle-favorite-article ::toggle-favorite-article)
(def >toggle-favorite-article-success ::toggle-favorite-article-success)
(def >logout ::logout)
...
(reg-event-fx                                            ;; usage: (dispatch [>initialise-db])
 ...
 [(inject-cofx db/>local-store-user)]                    ;; gets user from localstore, and puts into coeffects arg
 ...
 (fn [{:keys [db]} _]                                      ;; second parameter is not important, therefore _
   {:db         (assoc-in db [:loading :tags] true)
    :http-xhrio {:method          :get
                 ...
                 :response-format (json-response-format {:keywords? true}) ;; json response and all keys to keywords
                 :on-success      [>get-tags-success]    ;; trigger >get-tags-successevent event
...
(defn valid-credentials? [credentials]
  (s/valid? user-spec/login credentials))
 ...
 (fn [{:keys [db]} [_ credentials]]                  ;; credentials = {:email ... :password ...}
   (if (valid-credentials? credentials)
    {:db         (assoc-in db [:loading :login] true)
     ...
     {:db (assoc-in db [:errors :login] {:credentials ["Invalid login credentials."]})}))) 
